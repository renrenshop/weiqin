	...
	echo <<<EOF
		<div class="panel panel-default">
			...
			<div class="panel-body" style="overflow-y:scroll;max-height:400px;line-height:20px;">
				...
				<p>
					感谢群内童鞋：小母猪(2329459260)/DK(2329459260)/若水上善(3142223672
)/何必再健(250744110)/易水寒/;-D(171847271) 参与研究修改和测试
				</p>
				<p>
...
function tpl_install_finish() {
	...
	<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> 若有疑问，可以加微信：yunfei3q  或者访问：https://www.yibaizu.com</div>
