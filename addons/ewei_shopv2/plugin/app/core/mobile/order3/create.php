...
class Create_EweiShopV2Page extends AppMobilePage 
{
	...
	public function main() 
	{
		...
		$_W['shopshare']['hideMenus'] = array('menuItem:share:qq', 'menuItem:share:QZone', 'menuItem:share:email', 'menuItem:copyUrl', 'menuItem:openWithSafari', 'menuItem:openWithBrowser', 'menuItem:share:timeline', 'menuItem:share:appMessage');
		$allgoods = array();
