...
$item = pdo_fetch(
    "SELECT * FROM " . tablename("ewei_shop_goods") . " WHERE id = :id and uniacid = :uniacid",
...
if( $_W["ispost"] ) 
{
	...
	$data = array(
        ...
        "presellsendtype"       => intval($_GPC["presellsendtype"]), "presellsendstatrttime" => strtotime($_GPC["presellsendstatrttime"]),
        ...
        "istime"                => intval($_GPC["istime"]), "timestart" => strtotime($_GPC["saletime"]["start"]),
        "timeend"               => strtotime($_GPC["saletime"]["end"]),
        "description"           => trim($_GPC["description"]), "goodssn" => trim($_GPC["goodssn"]),
        "unit"                  => trim($_GPC["unit"]),
...
if( !empty($id) ) 
{
	...
	if( 0 < count($options) ) 
	{
		...
		if( $canedit ) 
		{
				...
				$discounts_html .= "<th>
                                        <div class=\"\">
                                            ...
                                            <div class=\"input-group\">
                                                <input type=\"text\" class=\"form-control  input-sm discount_" . $level["key"] . "_all\" VALUE=\"\"/>
                                                <span class=\"input-group-addon\">
                                                    <a href=\"javascript:;\" class=\"fa fa-angle-double-down\" title=\"批量设置\" onclick=\"setCol('discount_" . $level["key"] . "');\"></a>
                                                </span>
                                             </div>
                                        </div>
                                     </th>";

				$isdiscount_discounts_html .= "<th>
                                                    <div class=\"\">
                                                        <div style=\"padding-bottom:10px;text-align:center;\">
                                                            " . $level["levelname"] . "
                                                        </div>
                                                        <div class=\"input-group\">
                                                            <input type=\"text\" class=\"form-control  input-sm isdiscount_discounts_" . $level["key"] . "_all\" VALUE=\"\"/>
                                                            <span class=\"input-group-addon\">
                                                                <a href=\"javascript:;\" class=\"fa fa-angle-double-down\" title=\"批量设置\" onclick=\"setCol('isdiscount_discounts_" . $level["key"] . "');\"></a>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </th>";
			...
			if( $item["type"] == 3 ) 
			{
				$html .= "<th>
                                <div class=\"\">
                                    ...
                                    <div class=\"input-group\">
                                        <input type=\"text\" class=\"form-control input-sm option_stock_all\" readonly=\"readonly\" VALUE=\"\"  />
			...
			$html .= "<th class=\"type-4\">
                            <div class=\"\">
                                <div style=\"padding-bottom:10px;text-align:center;\">预售价</div>
                                <div class=\"input-group\">
                                    <input type=\"text\" class=\"form-control  input-sm option_presell_all\"  VALUE=\"\"/>
                                    <span class=\"input-group-addon\">
                                        <a href=\"javascript:;\" class=\"fa fa-angle-double-down\" title=\"批量设置\" onclick=\"setCol('option_presell');\"></a>
                                    </span>
                                </div>
                            </div>
                      </th>";
            ...
            $html .= "<th class=\"type-4\">
                        <div class=\"\">
                            ...
                            <div class=\"input-group\">
                                <input type=\"text\" class=\"form-control input-sm option_productprice_all\" VALUE=\"\" /><span class=\"input-group-addon\">
                                    <a href=\"javascript:;\" class=\"fa fa-angle-double-down\" title=\"批量设置\" onclick=\"setCol('option_productprice');\"></a>
                                </span>
                            </div>
                        </div>
                      </th>";
			...
			$html .= "<th>
                        <div class=\"\">
                            ...
                            <div class=\"input-group\">
                                <input type=\"text\" class=\"form-control input-sm option_goodssn_all\" VALUE=\"\" />
                                <span class=\"input-group-addon\">
                                    <a href=\"javascript:;\" class=\"fa fa-angle-double-down\" title=\"批量设置\" onclick=\"setCol('option_goodssn');\"></a>
                                </span>
                            </div>
                        </div>
                      </th>";
			$html .= "<th>
                        <div class=\"\">
                            ...
                            <div class=\"input-group\">
                                <input type=\"text\" class=\"form-control input-sm option_productsn_all\" VALUE=\"\" />
                                <span class=\"input-group-addon\">
                                    <a href=\"javascript:;\" class=\"fa fa-angle-double-down\" title=\"批量设置\" onclick=\"setCol('option_productsn');\"></a>
                                </span>
                            </div>
                        </div>
                      </th>";
			$html .= "<th>
                        <div class=\"\">
                            ...
                            <div class=\"input-group\">
                                <input type=\"text\" class=\"form-control input-sm option_weight_all\" VALUE=\"\" />
                                <span class=\"input-group-addon\">
                                    <a href=\"javascript:;\" class=\"fa fa-angle-double-down\" title=\"批量设置\" onclick=\"setCol('option_weight');\"></a>
                                </span>
                            </div>
                        </div>
                      </th>";
